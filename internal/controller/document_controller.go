...
// +kubebuilder:rbac:groups=doc.hermaeus.io,resources=documents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=doc.hermaeus.io,resources=documents/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=doc.hermaeus.io,resources=documents/finalizers,verbs=update
